            ...
            <View className=' bg-white rounded-t-[30px] flex-1'>
                ...
                <ScrollView className='flex-1 px-3'>
                    ...
                    <View className='mt-8 flex-row items-center border-2 border-gray-300 p-1 rounded-md'>
                        ...
                        <TextInput onChangeText={(text) => setData({ ...data, firstName: text })}
                            placeholderTextColor={'gray'}
                            style={{
                                fontSize: 16,
                            }}
                            autoCapitalize='none'
                            className=' w-full flex-row items-center outline-none p-2' placeholder='Your First Name' />
                    </View>
                    <View className='mt-4 flex-row items-center border-2 border-gray-300 p-1 rounded-md'>
                        ...
                        <TextInput onChangeText={(text) => setData({ ...data, lastName: text })}
                            ...
                            className=' w-full flex-row items-center outline-none p-2' placeholder='Your Last Name' />
                    </View>
                    <View className='mt-4 flex-row items-center border-2 border-gray-300 p-1 rounded-md'>
